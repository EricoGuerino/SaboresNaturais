...
function gravarScrollPosition()
{
	scollPosition = $('#formAdicionarCliente:cep_est').scrollTop();
};

function setarScrollPosition()
{
	$('#formAdicionarCliente:cep_est').scrollTop(scrollPosition);
};
